    ...
    export default function Poll({ activePopup, closePopup }) {
        ...
        return (
            ...
            {/* Thank You Screen */}
            {showThankYou && !showResults && <p className="text-center text-gray-700 p-4 text-sm">
                Grazie per aver votato!<br />A breve i risultati</p>}
            ...
            {showResults && (
                ...
                {results.length > 0 ? (
                    ...
                    <p className="text-center text-red-500">Nessun risultato disponibile.</p>
                )}
                </div>
            )}
            </div>
